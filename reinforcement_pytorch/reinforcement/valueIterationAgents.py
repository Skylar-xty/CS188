...
class ValueIterationAgent(ValueEstimationAgent):
    ...
    def runValueIteration(self):
        ...
        #     nextinfo = self.mdp.getTransitionStatesAndProbs(current_state, action)
        #
    ...
    def computeQValueFromValues(self, state, action):
        ...
        nextinfo = self.mdp.getTransitionStatesAndProbs(state, action)
        q_value = 0
        for nextstate, prob in nextinfo:
