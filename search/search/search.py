...
def depthFirstSearch(problem: SearchProblem):
    ...
    while not openset.isEmpty():
        ...
        # stop condition: the current node is the goal
        ...
        if state not in visited:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                if successor not in visited:
                    openset.push((successor, actions+[action]))
    return []
    util.raiseNotDefined()
...
def uniformCostSearch(problem: SearchProblem):
    ...
    openset.push((problem.getStartState(), [], 0),0)

    while not openset.isEmpty():
        state, actions, currentcost = openset.pop()
        ...
        if state not in visited or currentcost < visited[state]:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                ...
                openset.update((successor, actions+[action],newcost),newcost)
    ...
    while not openset.isEmpty():
        ...
        if state not in visited or currentcost < visited[state]:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                ...
                openset.update((successor, actions+[action],newcost),fcost)
